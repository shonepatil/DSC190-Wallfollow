...
{
  return max_serialized_size_custom_interfaces__action__Move_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_custom_interfaces__action__Move_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_custom_interfaces__action__Move_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_custom_interfaces__action__Move_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_custom_interfaces__action__Move_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_custom_interfaces__action__Move_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_custom_interfaces__action__Move_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_custom_interfaces__action__Move_FeedbackMessage(
    full_bounded, 0);
}
